...
![](/images/{{slug}}/stock-by-sectors-china-.png)
...
This analysis draws from data sourced by the Nepal Rastra Bank (NRB) and aggregated datasets from Open Data Nepal (ODN). The primary source of information is taken from the Foreign Direct Investment in Nepal Report, FY 2022/23 published by NRB.
